namespace FaruSneaker.Object
{
    partial class Payment_co
    {
        ...
        private void InitializeComponent()
        {
            ...
            txt_Search = new CustomControls.RJControls.RJTextBox();
            ...
            txt_Search.BorderColor = Color.Transparent;
            txt_Search.BorderFocusColor = Color.Transparent;
            txt_Search.BorderSize = 1;
            txt_Search.Cursor = Cursors.IBeam;
            txt_Search.Font = new Font("Bahnschrift Condensed", 12F, FontStyle.Regular, GraphicsUnit.Point);
            txt_Search.ForeColor = Color.Black;
            txt_Search.Location = new Point(21, 20);
            txt_Search.Margin = new Padding(4);
            txt_Search.Multiline = true;
            txt_Search.Name = "txt_Search";
            txt_Search.Padding = new Padding(7);
            txt_Search.PasswordChar = false;
            txt_Search.Size = new Size(627, 39);
            txt_Search.TabIndex = 1;
            txt_Search.Texts = "";
            txt_Search.UnderlinedStyle = false;
            // 
            // pictureBox1
            // 
